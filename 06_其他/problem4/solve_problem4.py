...
def parse_arguments(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--initial-max-step", type=float, default=5.0)
    parser.add_argument("--drying-max-step", type=float, default=30.0)
    parser.add_argument("--post-environment-temperature-c", type=float)
    parser.add_argument("--post-environment-moisture", type=float)
