#!/usr/bin/env python3
"""Idempotent parallel ultrafine run for Questions 3 and 4.
...
RUN_ROOT = ROOT / "ultrafine_runs" / "fixed_50_005"
...
def build_q3_final(results: dict[str, Any], environment: q3.EnvironmentData) -> dict[str, Any]:
    if Q3_FINAL.is_dir():
        ...
        return validation
    fine = results["q3_n2560_dt0p5"]
    spatial_1 = common_profile_comparison(results["q3_n640_dt0p5"], results["q3_n1280_dt0p5"])
    spatial_2 = common_profile_comparison(results["q3_n1280_dt0p5"], fine)
    temporal_1 = common_profile_comparison(results["q3_n2560_dt2"], results["q3_n2560_dt1"])
    temporal_2 = common_profile_comparison(results["q3_n2560_dt1"], fine)
    ...
    lines = [
        ...
        f"- 主网格：N=2560，均匀空间步长 {0.02 / 2560:.10e} m；",
        "- 主时间步：0.5 s；",
...
def build_q4_final(results: dict[str, Any], environment: q4.EnvironmentData, radius: q4.RadiusData) -> dict[str, Any]:
    if Q4_FINAL.is_dir():
        ...
        return validation
    fine = results["q4_n6080_fine"]
    spatial = q4.spatial_convergence(
        results["q4_n1520_fine"], results["q4_n3040_fine"], fine
    )
    temporal_1 = q4.common_field_comparison(
        results["q4_n6080_time_coarse"], results["q4_n6080_time_medium"]
    )
    temporal_2 = q4.common_field_comparison(results["q4_n6080_time_medium"], fine)
...
def main() -> int:
    ...
    tasks = [
        {"id": "q3_n640_dt0p5", "problem": 3, "radial_cells": 640, "time_step_s": 0.5},
        {"id": "q3_n1280_dt0p5", "problem": 3, "radial_cells": 1280, "time_step_s": 0.5},
        {"id": "q3_n2560_dt0p5", "problem": 3, "radial_cells": 2560, "time_step_s": 0.5},
        {"id": "q3_n2560_dt2", "problem": 3, "radial_cells": 2560, "time_step_s": 2.0},
        {"id": "q3_n2560_dt1", "problem": 3, "radial_cells": 2560, "time_step_s": 1.0},
        {"id": "q4_n1520_fine", "problem": 4, "radial_cells": 1520, "rtol": 5.0e-12, "initial_max_step_s": 0.5, "drying_max_step_s": 2.5},
        {"id": "q4_n3040_fine", "problem": 4, "radial_cells": 3040, "rtol": 5.0e-12, "initial_max_step_s": 0.5, "drying_max_step_s": 2.5},
        {"id": "q4_n6080_fine", "problem": 4, "radial_cells": 6080, "rtol": 5.0e-12, "initial_max_step_s": 0.5, "drying_max_step_s": 2.5},
        {"id": "q4_n6080_time_coarse", "problem": 4, "radial_cells": 6080, "rtol": 2.0e-11, "initial_max_step_s": 2.0, "drying_max_step_s": 10.0},
        {"id": "q4_n6080_time_medium", "problem": 4, "radial_cells": 6080, "rtol": 1.0e-11, "initial_max_step_s": 1.0, "drying_max_step_s": 5.0},
    ]
    manifest = {
        "schema": 1,
        "boundary_after_4h": {"temperature_c": 50.0, "moisture_kg_kg": 0.05},
